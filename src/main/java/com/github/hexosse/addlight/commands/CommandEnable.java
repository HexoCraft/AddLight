...
public class CommandEnable
{
    ...
    public static void execute(CommandSender sender)
    {
        ...
        sender.sendMessage(ChatColor.GREEN + "[AddLight] " + ChatColor.WHITE + "left click an item to add light!");
        sender.sendMessage(ChatColor.GREEN + "[AddLight] " + ChatColor.WHITE + "right click an item to remove light!");
    }
}
